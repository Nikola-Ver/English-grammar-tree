...
export const TENSES: Record<string, Tense> = {
  present_simple: {
    ...
    mistakes: [
      '<s>She work</s> → She <em>works</em>',
      '<s>Do she likes?</s> → Does she like?',
  ...
  present_continuous: {
    ...
    mistakes: [
      '<s>I am knowing</s> → stative verbs не употребляются в Continuous',
      '<s>She is working usually</s> → She <em>usually works</em> (привычка = PS)',
    ],
  },
  past_simple: {
    name: 'Past Simple',
    ...
    mistakes: [
      '<s>I goed</s> → I <em>went</em>',
      "<s>I didn't went</s> → I didn't <em>go</em>",
      '<s>I have seen him yesterday</s> → I <em>saw</em> him yesterday',
    ],
  },
  past_continuous: {
    ...
    mistakes: [
      '<s>She were working</s> → She <em>was</em> working',
      '<s>I was work</s> → I was <em>working</em>',
    ],
  },
  present_perfect: {
  ...
  present_perfect_continuous: {
    ...
    mistakes: [
      "<s>I've been know</s> → stative verbs не в Continuous",
      "<s>I've been learning since two years</s> → <em>for</em> two years",
    ],
  },
  past_perfect: {
    name: 'Past Perfect',
    ...
    mistakes: [
      '<s>When I arrived, she already left</s> → she <em>had</em> already left',
      '<s>He had never see</s> → He had never <em>seen</em>',
    ],
  },
  past_perfect_continuous: {
    ...
    mistakes: [
      '<s>She had been work</s> → She had been <em>working</em>',
      '<s>How long had you waiting?</s> → had you <em>been waiting</em>',
    ],
  },
  future_will: {
    ...
    mistakes: ['<s>I will to go</s> → I will <em>go</em>', '<s>She wills come</s> → She will come'],
  },
  future_going_to: {
  ...
  future_perfect: {
    ...
    mistakes: [
      '<s>By Friday I will finish</s> → I will <em>have finished</em>',
      "<s>I'll have finish</s> → I'll have <em>finished</em>",
    ],
  },
};
